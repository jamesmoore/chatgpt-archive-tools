...
namespace ChatGpt.Archive.Api.Services
{
    ...
    {
        private ConcurrentDictionary<string, FileSystemAsset> assetCache = new();

        public void StoreAsset(FileSystemAsset asset)
        {
        ...
        public FileSystemAsset? GetAsset(string key)
        {
