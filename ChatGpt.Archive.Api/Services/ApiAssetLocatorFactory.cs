...
namespace ChatGpt.Archive.Api.Services
{
        ...
        CompositeAssetLocatorFactory compositeAssetLocatorFactory)
    {
        public IAssetLocator Create()
        {
            ...
            // Compared to the CLI, this uses a slightly different approach - per file here, ordered by last write time. CLI orders by parsed conversation update time (more expensive).
