...
public class HtmlFormatterTests
{
    ...
    [Fact]
    public void BootstrapHtmlFormatter_FormatHtmlPage_ProducesValidOutput()
    {
        // Arrange
        var page = new HtmlPage(
            "Test Title",
        ...
        var formatter = new BootstrapHtmlFormatter();
    ...
    [Fact]
    public void BootstrapHtmlFormatter_FormatHtmlPage_DifferentiatesUserMessages()
    {
        // Arrange
        var page = new HtmlPage(
            "Test",
        ...
        // Assert - Bootstrap uses specific classes for user messages
        Assert.Contains("justify-content-end", html);
        Assert.Contains("rounded-3", html);
    }
}
